export interface SnapshotPreview1 {
    ...
    path_filestat_set_times(fd: number, flags: number, path_ptr: number, path_len: number, atim: bigint, mtime: bigint, fst_flags: number): number;
    ...
    path_open(fd: number, dir_flags: number, path_ptr: number, path_len: number, oflags: number, rights_base: bigint, rights_inheriting: bigint, fdflags: number, retptr0: number): number;
    path_readlink(fd: number, path_ptr: number, path_len: number, buf_ptr: number, buf_len: number, retptr0: number): number;
    ...
    sock_recv(fd: number, ri_data_ptr: number, ri_data_len: number, ri_flags: number, retptr0: number, retptr1: number): number;
...
export declare enum Clock {
    REALTIME = 0,
    MONOTONIC = 1,
    PROCESS_CPUTIME_ID = 2,
    THREAD_CPUTIME_ID = 3
}
export declare enum Whence {
...
export declare enum PreopenType {
    DIR = 0
}
...
export declare const LookupFlags: {
    SYMLINK_FOLLOW: number;
};
...
export declare const FileDescriptorFlags: {
    APPEND: number;
    DSYNC: number;
    NONBLOCK: number;
    RSYNC: number;
...
export declare const RightsFlags: {
    FD_DATASYNC: bigint;
    FD_READ: bigint;
    FD_SEEK: bigint;
    FD_FDSTAT_SET_FLAGS: bigint;
    FD_SYNC: bigint;
    FD_TELL: bigint;
    FD_WRITE: bigint;
    FD_ADVISE: bigint;
    FD_ALLOCATE: bigint;
    PATH_CREATE_DIRECTORY: bigint;
    PATH_CREATE_FILE: bigint;
    PATH_LINK_SOURCE: bigint;
    PATH_LINK_TARGET: bigint;
    PATH_OPEN: bigint;
    FD_READDIR: bigint;
    PATH_READLINK: bigint;
    PATH_RENAME_SOURCE: bigint;
    PATH_RENAME_TARGET: bigint;
    PATH_FILESTAT_GET: bigint;
    PATH_FILESTAT_SET_SIZE: bigint;
    PATH_FILESTAT_SET_TIMES: bigint;
    FD_FILESTAT_GET: bigint;
    FD_FILESTAT_SET_SIZE: bigint;
    FD_FILESTAT_SET_TIMES: bigint;
    PATH_SYMLINK: bigint;
    PATH_REMOVE_DIRECTORY: bigint;
    PATH_UNLINK_FILE: bigint;
    POLL_FD_READWRITE: bigint;
    SOCK_SHUTDOWN: bigint;
    SOCK_ACCEPT: bigint;
};
export declare const FileStatTimestampFlags: {
    ATIM: number;
    ATIM_NOW: number;
    MTIM: number;
    MTIM_NOW: number;
};
export declare const SubscriptionClockFlags: {
    SUBSCRIPTION_CLOCK_ABSTIME: number;
};
export declare const EventReadWriteFlags: {
    FD_READWRITE_HANGUP: number;
};
export declare const FILESTAT_SIZE = 64;
export declare const SUBSCRIPTION_SIZE = 48;
export declare const EVENT_SIZE = 32;
